  ...
  policy = jsonencode({
    ...
    Statement = [
      ...
      },
      {
        ...
        Resource = "arn:aws:ecr:${var.aws_region}:${var.account_id}:repository/${var.project}-*"
      },
      {
        Effect   = "Allow"
  ...
  policy = jsonencode({
    ...
    Statement = [
      ...
      },
      {
        ...
        Resource = [
          "arn:aws:s3:::kfupm-geo-tf-state",
          "arn:aws:s3:::kfupm-geo-tf-state/*",
          "arn:aws:dynamodb:${var.aws_region}:${var.account_id}:table/kfupm-geo-tf-lock"
        ]
      }
    ]
  })
